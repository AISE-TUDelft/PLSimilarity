...
def main():
    ...
    if model_args.tokenizer_name:
        tokenizer = AutoTokenizer.from_pretrained("tokenizer_all_languages_mathematica", **tokenizer_kwargs)
    elif model_args.model_name_or_path:
        tokenizer = AutoTokenizer.from_pretrained("tokenizer_all_languages_mathematica", **tokenizer_kwargs)
    else:
        raise ValueError(
    ...
    trainer.args.save_steps = 10000
    trainer.args.max_steps= 100000
    # Training
    if training_args.do_train:
        checkpoint = None
